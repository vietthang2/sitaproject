...
namespace ECNET.Office.Endpoints
{
    ...
    using MyRepository = Repositories.TblTransactionLocationRepository;
    using MyRow = Entities.TblTransactionLocationRow;
    using System;

    [Route("Services/Office/TblTransactionLocation/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class TblTransactionLocationController : ServiceEndpoint
    {
