...
namespace ECNET.Office.Endpoints
{
    ...
    using MyRepository = Repositories.TblUnitRepository;
    using MyRow = Entities.TblUnitRow;
    using System;

    [Route("Services/Office/TblUnit/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class TblUnitController : ServiceEndpoint
    {
