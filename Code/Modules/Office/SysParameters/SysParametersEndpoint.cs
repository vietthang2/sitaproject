...
namespace ECNET.Office.Endpoints
{
    ...
    using MyRepository = Repositories.SysParametersRepository;
    using MyRow = Entities.SysParametersRow;
    using System;

    [Route("Services/Office/SysParameters/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class SysParametersController : ServiceEndpoint
    {
