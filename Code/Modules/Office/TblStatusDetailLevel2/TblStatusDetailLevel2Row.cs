...
namespace ECNET.Office.Entities
{
    ...
    [ConnectionKey("Default"), Module("Office"), TableName("[dbo].[tblStatusDetailLevel2]")]
    [DisplayName("Tbl Status Detail Level2"), InstanceName("Tbl Status Detail Level2")]
    [ReadPermission(PermissionKeys.StatusDetail.View)]
    [ModifyPermission(PermissionKeys.StatusDetail.Modify)]
    [LookupScript("dbo.tblStatusDetailLevel2", Permission = "*")]//add thêm
    public sealed class TblStatusDetailLevel2Row : Row, IIdRow, IAuditLog
    {
        ...
        [DisplayName("Status Is New"), Expression("jStatus.[IsNew]")]
        public Boolean? StatusIsNew
        {
            get { return Fields.StatusIsNew[this]; }
            set { Fields.StatusIsNew[this] = value; }
        }
        ...
        public TblStatusDetailLevel2Row()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public BooleanField StatusIsNew;
        }
    }
}
