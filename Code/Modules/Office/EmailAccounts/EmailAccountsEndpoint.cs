...
namespace ECNET.Office.Endpoints
{
    ...
    using MyRepository = Repositories.EmailAccountsRepository;
    using MyRow = Entities.EmailAccountsRow;
    using System;

    [Route("Services/Office/EmailAccounts/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class EmailAccountsController : ServiceEndpoint
    {
