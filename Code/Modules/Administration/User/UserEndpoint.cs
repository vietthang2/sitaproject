...
namespace ECNET.Administration.Endpoints
{
    using Entities;
    using Repositories;
    using Serenity;
    ...
    public class UserController : ServiceEndpoint
    {
        ...
        public ListResponse<MyRow> List(IDbConnection connection, ListRequest request)
        {
           var resp=new MyRepository().List(connection, request);
            //var listSupperUser = new List<string>();
            //listSupperUser.Add("system");
            //listSupperUser.Add("vanhanh");
            //listSupperUser.Add("admin");
            //var currentUser= ((UserDefinition)Serenity.Authorization.UserDefinition).Username;
            //if (listSupperUser.Contains(currentUser))
            //{
            //    resp.Entities.Where(k => !listSupperUser.Contains(k.Username));
            //}
            return resp;
        }
