...
namespace ECNET.Administration.Entities
{
    using ECNET.Web.Modules.Administration.Common;
    ...
    public sealed class RoleRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Level Approval"), Size(100),  QuickSearch]
        public LevelApproval? LevelApproval
        {
            get { return (LevelApproval?)Fields.LevelApproval[this]; }
            set { Fields.LevelApproval[this] = (Int32)value; }
        }
