...
namespace ECNET.Navigation
{
    using ECNET.Administration.Entities;
    using Serenity;
    ...
    public partial class NavigationModel
    {
        ...
        {
            //HashSet<int> GroupRole = new PermissionService().GetUserRoles(int.Parse(Authorization.UserId));
            //bool isApprove = false;
            //foreach (var roleId in GroupRole)
            //{
            //     if (roleId == 4) isApprove= true;// hard code
