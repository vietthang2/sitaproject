...
using Administration = Sita.Administration.Pages;

[assembly: NavigationMenu(9000, "Administration", icon: "fa-desktop")]
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: Sita.Administration.PermissionKeys.Security, icon: "fa-ban", Target = "_blank")]
...
[assembly: NavigationLink(9000, "Administration/Background Jobs", url: "~/jobs", permission: Sita.Administration.PermissionKeys.Security, icon: "fa-refresh")]