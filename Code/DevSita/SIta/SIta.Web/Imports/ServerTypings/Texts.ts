namespace Sita.Texts {
    ...
    declare namespace Db {
        ...
        namespace Default {
            ...
            namespace TblAdiType {
                export const Code: string;
                export const Name: string;
            }

            namespace TblBags {
                export const BaggageTag: string;
                export const Bpm: string;
                export const Bsm: string;
                export const DDMM: string;
                export const FlightRef: string;
                export const Id: string;
                export const Processed: string;
                export const TimeRcvBpm: string;
                export const TimeRcvBsm: string;
                export const YYYY: string;
            }

            namespace TblBagsHistory {
                export const BaggageTag: string;
                export const Bpm: string;
                export const Bsm: string;
                export const Ddmm: string;
            ...
            namespace TblField {
                export const FlightIndentify: string;
                export const FlightRef: string;
                export const Id: string;
            ...
            namespace TblFlight {
                export const Adi: string;
                export const Chute: string;
                export const DDMM: string;
                export const DateBoundary: string;
                export const DateCreated: string;
                export const DateUpdated: string;
                export const Identify: string;
                export const LastChanged: string;
                export const LineCode: string;
                export const ListField: string;
                export const Number: string;
                export const ScheduleDate: string;
                export const SiteIata: string;
                export const SoftReplace: string;
                export const UserCreated: string;
