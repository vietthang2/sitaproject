...
{
	public partial class Conn_BaseBusiness : IDisposable
	{
		#region members
		bool _isDisposed = false;
		protected Conn_TxConnectionProvider _txConnectionProvider;
		protected List<Conn_BaseBusiness> _listBusObjects = new List<Conn_BaseBusiness>();
		int _nestLevel;
		#endregion

		#region initialization
		public Conn_BaseBusiness()
		{
			Init();
		}
		...
		protected virtual void RegisterDataObject(Conn_BaseData dataObject)
		{
				if(_txConnectionProvider == null)
					_txConnectionProvider = new Conn_TxConnectionProvider();
		
				if(dataObject != null)
					dataObject.ConnectionProvider = _txConnectionProvider;
		}

		protected virtual void RegisterBusinessObject(Conn_BaseBusiness busObject)
		{
				if(_txConnectionProvider == null)
					_txConnectionProvider = new Conn_TxConnectionProvider();
		...
		public virtual void BeginTransaction(string trans)
		{
			if(_nestLevel == 0)
			{
				...
				if(_listBusObjects != null)
					foreach (Conn_BaseBusiness busObj in _listBusObjects)
		...
		public Conn_TxConnectionProvider ConnectionProvider
		{
			get
			{
