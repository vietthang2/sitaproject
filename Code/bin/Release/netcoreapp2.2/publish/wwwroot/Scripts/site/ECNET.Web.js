...
(function (ECNET) {
    ...
    })(Northwind = ECNET.Northwind || (ECNET.Northwind = {}));
})(ECNET || (ECNET = {}));
var ECNET;
(function (ECNET) {
    var Northwind;
...
(function (ECNET) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'ECNET.Northwind.Gender', 'ECNET.Northwind.Entities.Gender');
    })(Northwind = ECNET.Northwind || (ECNET.Northwind = {}));
})(ECNET || (ECNET = {}));
var ECNET;
(function (ECNET) {
...
(function (ECNET) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'ECNET.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = ECNET.Northwind || (ECNET.Northwind = {}));
})(ECNET || (ECNET = {}));
var ECNET;
(function (ECNET) {
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                ECNET.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(ECNET.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(ECNET.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        ECNET.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: ECNET.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return ECNET.LanguageList.getValue();
            };
